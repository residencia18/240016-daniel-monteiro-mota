...
public class CadastroApplication {
	...
	public static void main(String[] args) {
	    ...
	    System.out.printf("Endereço: %s%n",fake.address().streetAddress());
	    System.out.printf("Cidade: %s%n",fake.address().cityName());
	    System.out.printf("País: %s%n",fake.address().country());
